...
@section('title', "İş Kazası")

@section('page_name', "İş Kazası")
            ...
            <div class="col-md-3" id="card_id_{{$tracking->id}}">
                <div class="card card-primary collapsed-card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-block btn-success" onclick="$.lawSend({{$tracking->id}})" >Hukuka Gönder</button>
    ...
    <script>
        $( document ).ready(function() {
            ...
            $.lawCreate = function () {
                ...
                $.ajax({
                    url: "{{route('admin.tracking.lawWorkAccidentCreate')}}",
                    type: "POST",
                    data: {
